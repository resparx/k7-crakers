...
const CartModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-gray-800 bg-opacity-75 flex cartItems-center justify-center z-50">
      <div className="relative bg-white rounded-lg shadow-lg w-screen sm:w-[50vw] my-auto mx-4 md:mx-0 h-[80vh] overflow-scroll">
              ...
              {cartItems.map((item, index) => (
                <li
                  ...
                  className={`flex justify-between py-2 ${
                    index + 1 === cartItems.length ? `` : `border-b`
                  }`}
                >
                  <div>
        ...
        <div className={styles['fireworks-container']}>
                    <div className={styles.firework}></div>
                    <div className={styles.firework}></div>
                    <div className={styles.firework}></div>
                    {/* Add more firework elements as needed */}
                </div>
      </div>
    </div>
  );
